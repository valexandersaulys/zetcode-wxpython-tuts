...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        # are the flags within its "slot" in that grid?
        ...
        # create a "soft outline" box
        sb = wx.StaticBox(panel, label="Optional Attributes")

        boxsizer = wx.StaticBoxSizer(sb, wx.VERTICAL)
        boxsizer.Add(
            wx.CheckBox(panel, label="Public"), flag=wx.LEFT | wx.TOP, border=5
        )
        boxsizer.Add(
            wx.CheckBox(panel, label="Generate Default Constructor"),
            flag=wx.LEFT,
            border=5,
        )
        boxsizer.Add(
            wx.CheckBox(panel, label="Generate Main Method"),
        ...
        sizer.Add(
            button5, pos=(7, 4), span=(1, 1), flag=wx.BOTTOM | wx.RIGHT, border=10
        )
